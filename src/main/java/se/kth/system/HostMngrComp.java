...
public class HostMngrComp extends ComponentDefinition {
    ...
    private void connectApp() {
        ...
        appMngrComp = create(AppMngrComp.class, new AppMngrComp.Init(extPorts, selfAdr, croupierId, set));
    ...
    public static class Init extends se.sics.kompics.Init<HostMngrComp> {
        ...
        public enum SET {GrowOnly, TwoP, OR, Graph}
        public final SET set;

        public Init(KAddress selfAdr, KAddress bootstrapServer, OverlayId croupierId, String type) {
            this.selfAdr = selfAdr;
            this.bootstrapServer = bootstrapServer;
            this.croupierId = croupierId;
            if(type.equals("G_Set")){
            	this.set = SET.GrowOnly;
            }else if(type.equals("TwoP_Set")){
            	this.set = SET.TwoP;
            }else if(type.equals("OR_Set")){
            	this.set = SET.OR;
            }else{
            	this.set = SET.Graph;
            }
